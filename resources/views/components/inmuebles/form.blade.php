                    ...
                    <div class="hidden w-full space-y-3 text-left" data-gallery-previews-wrapper>
                        ...
                        >
                            <template data-gallery-preview-template>
                                <div
                                    class="relative flex cursor-grab flex-col gap-3 rounded-xl border border-gray-800 bg-gray-900/70 p-3 shadow-lg shadow-black/30 transition hover:border-indigo-400/60"
                                    data-gallery-preview
                                >
                                    <div class="pointer-events-none absolute right-2 top-2 flex items-center gap-2" data-gallery-preview-actions>
                                        <span
                                        ...
                                        <button
                                            type="button"
                                            class="pointer-events-auto inline-flex h-7 w-7 items-center justify-center rounded-full bg-black/80 text-sm text-red-200 shadow-lg shadow-black/40 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-black/40"
