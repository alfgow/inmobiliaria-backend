    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        <div class="space-y-4">
            ...
            <div class="space-y-3">
                ...
                @else
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-300">
                        Guarda primero el inmueble para habilitar la galerÃ­a y subir fotografÃ­as.
                    </div>
                @endif
            </div>
        </div>
